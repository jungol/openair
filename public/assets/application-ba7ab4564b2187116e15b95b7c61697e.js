...
(function() {
  $.fn.takeNotesTest = function() {
    var keyboardSave, saveNote;
    $('.margin').each(function() {
      var i, line_height, lines, paragraph_content, paragraph_div, paragraph_height, val, _i, _results;
      ...
      _results = [];
      for (i = _i = 1; _i <= lines; i = _i += 1) {
        val = $(this).children('textarea').val();
        _results.push($(this).children('textarea').val(val + '\r\n'));
      }
      return _results;
    });
    $.each($('.temp_info').data('notes'), function(index, _arg) {
      var content, div, div_height, i, line_diff, line_height, location, margin, paragraph_content, paragraph_div, paragraph_height, paragraph_lines, text_lines, width, _i;
      location = _arg[0], content = _arg[1];
      margin = $('#' + location);
      ...
      if (line_diff > 0) {
        for (i = _i = 1; _i <= line_diff; i = _i += 1) {
          content = content + '\r\n';
        }
      }
      return margin.children('textarea').val(content);
    });
    keyboardSave = function(e, textarea) {
      if (e.keyCode === 13 && e.shiftKey) {
        textarea.blur();
        return saveNote(textarea);
      }
    };
    saveNote = function(textarea) {
      var content, copyid, data, paragraph_id;
    ...
    $('.margin').children('textarea').keydown(function(e) {
      var textarea;
      textarea = $(this);
      return keyboardSave(e, textarea);
    });
    $('.margin').children('textarea').on('blur', function() {
      var textarea;
      textarea = $(this);
      return saveNote(textarea);
    });
    return $('.margin').children('textarea').on('click', function() {
